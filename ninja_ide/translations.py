...
TR_COPY_FILE_PATH_TO_CLIPBOARD = tr("NINJA-IDE",
    "Copy full path with filename to clipboard")
TR_COPY_FILENAME_TO_CLIPBOARD = tr("NINJA-IDE", "Copy filename to clipboard")
TR_COPY_PATH_TO_CLIPBOARD = tr("NINJA-IDE", "Copy path to clipboard")
...
TR_REMOVE_LINE = tr("NINJA-IDE", "Remove the line/selection")
TR_MOVE_LINE_UP = tr("NINJA-IDE", "Move the line/selection up")
TR_MOVE_LINE_DOWN = tr("NINJA-IDE", "Move the line/selection down")
TR_CLOSE_CURRENT_TAB = tr("NINJA-IDE", "Close current tab")
TR_NEW_TAB = tr("NINJA-IDE", "New tab")
TR_OPEN_FILE = tr("NINJA-IDE", "Open File")
TR_SAVE_FILE = tr("NINJA-IDE", "Save File")
TR_SAVE_PROJECT_FILE = tr("NINJA-IDE", "Save current project opened files")
...
TR_OPEN_RECENT_CLOSED_FILE = tr("NINJA-IDE", "Open recent closed file")
TR_CHANGE_TO_NEXT_TAB = tr("NINJA-IDE", "Change to next Tab")
TR_CHANGE_TO_PREVIOUS_TAB = tr("NINJA-IDE", "Change to previous Tab")
TR_MOVE_TAB_TO_RIGHT = tr("NINJA-IDE", "Move tab to right")
TR_MOVE_TAB_TO_LEFT = tr("NINJA-IDE", "Move tab to left")
...
TR_CHANGE_KEYBOARD_FOCUS_BETWEEN_SPLITS = tr("NINJA-IDE",
    "Change keyboard focus between current splits")
...
TR_SHOW_TABS_IN_EDITOR = tr("NINJA-IDE", "Show/Hide Tabs in the Editor")
TR_HIGHLIGHT_OCCURRENCES = tr("NINJA-IDE",
    "Highlight occurrences for word under cursor")
TR_LOAD_DEFAULTS = tr("NINJA-IDE", "Load  Defaults")
TR_SHORCUTS_IN_MENUS_REFRESH_ON_RESTART = tr("NINJA-IDE",
    "The Shortcuts Text in the Menus are going to be refreshed on restart")
...
TR_SELECT_EXEC_OPTION_B = tr("NINJA-IDE",
    "-B: don't write .py[co] files on import")
TR_SELECT_EXEC_OPTION_D = tr("NINJA-IDE", "-d: debug output from parser")
TR_SELECT_EXEC_OPTION_E = tr("NINJA-IDE",
    "-E: ignore PYTHON* environment variables (such as PYTHONPATH)")
TR_SELECT_EXEC_OPTION_O = tr("NINJA-IDE",
    "-O: optimize generated bytecode slightly")
TR_SELECT_EXEC_OPTION_OO = tr("NINJA-IDE",
    "-OO: remove doc-strings in addition to the -O optimizations")
TR_SELECT_EXEC_OPTION_Q = tr("NINJA-IDE", "-Q: division options:")
TR_SELECT_EXEC_OPTION_s = tr("NINJA-IDE",
    "-s: don't add user site directory to sys.path")
TR_SELECT_EXEC_OPTION_S = tr("NINJA-IDE",
    "-S: don't imply 'import site' on initialization")
TR_SELECT_EXEC_OPTION_T = tr("NINJA-IDE",
    "-t: issue warnings about inconsistent tab usage")
TR_SELECT_EXEC_OPTION_TT = tr("NINJA-IDE",
    "-tt: issue errors about inconsistent tab usage")
TR_SELECT_EXEC_OPTION_V = tr("NINJA-IDE",
