...
TR_PREFERENCES_EDITOR_GENERAL_ENABLE_MINIMAP = tr("NINJA-IDE", "Use MiniMap")
TR_PREFERENCES_EDITOR_GENERAL_ENABLE_MINIMAP_TOOLTIP = tr(
    "NINJA-IDE", "Requires Restart,\nopacity unsupported on OsX")
