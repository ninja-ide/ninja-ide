...
from ninja_ide.gui.menus.lib.aboutdialog import AboutDialog
from ninja_ide.gui.menus.lib.highscoresdialog import HighscoresDialog
from ninja_ide.gui.menus.lib.highscores import HighScores
from ninja_ide.gui.menus.lib.images import get_icon_pixmap
from ninja_ide.gui.menus.lib.enum import Enum
from ninja_ide.gui.menus.lib.tetrismodel import TetrisBoard, Figure, FigureBank
from ninja_ide.gui.menus.lib.version import pyqtris_version
...
class TetrisMainWindow(QMainWindow, itab_item.ITabItem):
    """ The main tetris game window.
    """
    def __init__(self, winWidth=0, winHeight=0, parent=None):
        ...
        self.create_menu()
        self.create_main_frame(winWidth, winHeight)
    ...
    def create_main_frame(self, winWidth, winHeight):
        nrows = winHeight / 35
        ncols = winWidth / 65
        ...
        main_frame = QWidget()
        main_frame.setLayout(vertical_layout)
    ...
    def create_menu(self):
        ...
        self.toolbar.addAction(pause_game_action)
        self.toolbar.addSeparator()
        self.toolbar.addAction(highscores_action)
        self.toolbar.addSeparator()
